...
function FormalUl() {
    const[dollorData]=useState(data)
    ...
    return (
        ...
        <div className="container-fluid refine">
                <ul className='arev'>
                    <li > <Link to="/" style={{color:"black",textDecoration:"none"}}> HOME </Link>   <RiArrowRightSFill/> <u>FORMALS   </u> </li>
                </ul>
                <ul>
            ...
            <div className="bagh container-fluid p-0">
                <div className="bag container-fluid d-flex flex-wrap">
                    ...
                    {dollorData.formal.formal22.map((e)=>{
