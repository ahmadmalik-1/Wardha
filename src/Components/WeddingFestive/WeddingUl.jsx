...
function WeddingUl() {
    ...
    return (
        ...
        <div className="container-fluid refine">
                <ul className='arev'>
                    <li > <Link to="/" style={{color:"black",textDecoration:"none"}}> HOME </Link>   <RiArrowRightSFill/> <u>WEDDING FESTIVE  </u> </li>
                </ul>
                <ul>
