...
function PretUl() {
    ...
    return (
        ...
        <div className="container-fluid refine">
                <ul className='arev'>
                    <li > <Link to="/" style={{color:"black",textDecoration:"none"}}> HOME </Link>   <RiArrowRightSFill/> <u>PRET-A-PORTER</u> </li>
                </ul>
                <ul>
