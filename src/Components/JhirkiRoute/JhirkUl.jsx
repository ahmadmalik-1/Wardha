...
function JhirkUl() {
    const[princeData]=useState(data)
    ...
    return (
        ...
        <div className="container-fluid refine">
                <ul className='arev'>
                    <li > <Link to="/" style={{color:"black",textDecoration:"none"}}> HOME </Link>   <RiArrowRightSFill/> <u> JHIRKI BLOCK PRINTS  </u> </li>
                </ul>
                <ul>
            ...
            <div className="bagh container-fluid p-0">
                <div className="bag container-fluid d-flex flex-wrap">
                    ...
                    {princeData.jhirk.jhirk30.map((e)=>{
